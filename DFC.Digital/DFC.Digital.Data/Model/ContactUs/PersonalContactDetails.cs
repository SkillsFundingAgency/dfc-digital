...
namespace DFC.Digital.Data.Model
{
    public class PersonalContactDetails
    {
        ...
        [Required(ErrorMessage = "Select your question Category")]
        [Display(Name = "What is your question about?")]
        public string QuestionArea { get; set; }

        [DoubleRegex(
            FirstRegex = ServiceCommon.RegexPatterns.PostCode.UKPostCode,
            SecondRegex = ServiceCommon.RegexPatterns.PostCode.EnglishOrBFPOPostCode,
            IsAndOperator = true,
            IsRequired = true,
