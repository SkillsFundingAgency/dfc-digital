            ...
            if (relatedItems != null)
            {
                foreach (var relatedItem in relatedItems)
                {
                    relatedSkills.Add(new SocSkillMatrixItem
                    {
                        ...
                        ONetRank = dynamicContentExtensions.GetFieldValue<decimal?>(relatedItem, nameof(SocSkillMatrixItem.ONetRank)) != null ? dynamicContentExtensions.GetFieldValue<decimal?>(relatedItem, nameof(SocSkillMatrixItem.ONetRank)).ToString() : "0",
                        Rank = dynamicContentExtensions.GetFieldValue<decimal?>(relatedItem, nameof(SocSkillMatrixItem.Rank)) != null ? dynamicContentExtensions.GetFieldValue<decimal?>(relatedItem, nameof(SocSkillMatrixItem.Rank)).ToString() : "0",
