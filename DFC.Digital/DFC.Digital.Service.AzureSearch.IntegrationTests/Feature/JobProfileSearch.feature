...
#| Title                                 | AlternativeTitle                         | JobProfileSpecialism   | HiddenAlternativeTitle | JobProfileCategories | Overview | CollegeRelevantSubjects | UniversityRelevantSubjects | ApprenticeshipRelevantSubjects | WydDayToDayTasks | CareerPathAndProgression | WorkingPattern            | WorkingPatternDetails   | MinimumHours | MaximumHours | WorkingHoursDetails |
...
#| Actor                                 |                                          |                        |                        |                      |          |                         |                            |                                |                  |                          | freelance / self-employed | managing your own hours | 30           | 40           | a week              |
#| Barrister                             |                                          |                        |                        |                      |          |                         |                            |                                |                  |                          | freelance / self-employed | managing your own hours | 20           | 30           | a week              |
#| Bailiff                               |                                          |                        |                        |                      |          |                         |                            |                                |                  |                          | freelance / self-employed | managing your own hours | 30           | 40           | a week              |
#| Coroner                               |                                          |                        |                        |                      |          |                         |                            |                                |                  |                          | freelance / self-employed |                         | 0            | 0            | a month             |
#
...
Scenario: [DFC-8364 - A1] JP is tagged by 'WorkingPattern | WorkingPatternDetails | MinimumHours | MaximumHours | WorkingHoursDetails' with equal search weight. 
	Given the following job profiles exist:
		| Title     | AlternativeTitle | JobProfileSpecialism | HiddenAlternativeTitle | JobProfileCategories | Overview | CollegeRelevantSubjects | UniversityRelevantSubjects | ApprenticeshipRelevantSubjects | WydDayToDayTasks | CareerPathAndProgression | WorkingPattern            | WorkingPatternDetails   | MinimumHours | MaximumHours | WorkingHoursDetails |
		| Actor     |                  |                      |                        |                      |          |                         |                            |                                |                  |                          | freelance / self-employed | managing your own hours | 30           | 40           | a week              |
		| Barrister |                  |                      |                        |                      |          |                         |                            |                                |                  |                          | freelance / self-employed | managing your own hours | 20           | 30           | a week              |
		| Bailiff   |                  |                      |                        |                      |          |                         |                            |                                |                  |                          | freelance / self-employed | managing your own hours | 30           | 40           | a week              |
		| Coroner   |                  |                      |                        |                      |          |                         |                            |                                |                  |                          | freelance / self-employed |                         | 0            | 0            | a month             |
When I search using the search term 'actor, bailiff'
	Then the result list will contain '2' profile(s)
	And the profiles are listed in no specific order:
       | Title   | AlternativeTitle | JobProfileSpecialism | HiddenAlternativeTitle | JobProfileCategories | Overview | CollegeRelevantSubjects | UniversityRelevantSubjects | ApprenticeshipRelevantSubjects | WydDayToDayTasks | CareerPathAndProgression | WorkingPattern            | WorkingPatternDetails   | MinimumHours | MaximumHours | WorkingHoursDetails |
       | Actor   |                  |                      |                        |                      |          |                         |                            |                                |                  |                          | freelance / self-employed | managing your own hours | 30           | 40           | a week              |
