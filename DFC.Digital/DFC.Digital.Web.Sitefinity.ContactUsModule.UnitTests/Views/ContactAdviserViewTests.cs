...
{
    public class ContactAdviserViewTests
    {
        [Fact]
        ...
        public void Dfc7630ErrorSummaryViewTests(bool modelStateInvalid)
        {
            ...
            {
                errorSummaryView.ViewData.ModelState.AddModelError(nameof(ContactAdviserViewModel.ContactAdviserQuestionType), nameof(Exception.Message));
            }
