...
namespace DFC.Digital.Web.Sitefinity.CourseModule
{
    public interface ICourseSearchConverter
    {
        ...
        CourseSearchRequest GetCourseSearchRequest(string searchTerm, int recordsPerPage, string attendance, string studymode, string qualificationLevel, string distance, string dfe1619Funded, string pattern, int page);
