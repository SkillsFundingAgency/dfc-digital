        ...
        private static JobProfile GetDummyJobPRofile(bool useValidJobProfile)
        {
            return useValidJobProfile ?
                   new JobProfile
                   {
                       ...
                       WhatYouWillDoData = new WhatYouWillDo { EnvironmentTitle = "Working Environment", Location = "Office and Client Site", Uniform = "Casual / Smart Casual / Business Dress", Environment = "Friendly / Business / Secured", IsWYDCaDReady = true },
