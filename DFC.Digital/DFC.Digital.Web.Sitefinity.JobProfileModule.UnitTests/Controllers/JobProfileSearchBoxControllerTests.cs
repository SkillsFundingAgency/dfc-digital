...
using Xunit;
using IWebAppContext = DFC.Digital.Data.Interfaces.IWebAppContext;
    ...
    public class JobProfileSearchBoxControllerTests
    {
        ...
        public void IndexTest_Automapper_And_TotalMessage(string searchTerm, JobProfileSearchBoxController.PageMode mode, int resultsCount, int page = 1)
        {
            ...
            else
            {
                ...
                {
                    Title = searchTerm,
                    AlternativeTitle = new string[] { "alt" },
                    SalaryRange = "avg sal",
                    Overview = "overview",
                    UrlName = "dummy-url"
                };
                ...
                foreach (var dummyIndexItem in dummySearchResult.Results)
                {
                    expectedSearchResultsRawViewModel.Add(new JobProfileSearchResultItemViewModel
                    {
                        ...
                        ResultItemSalaryRange = dummyIndexItem.ResultItem.SalaryRange,
            ...
            var searchController = new Mvc.Controllers.JobProfileSearchBoxController(queryServiceFake, webAppContext, mapperCfg.CreateMapper(), loggerFake, fakeAsyncHelper, fakeSpellChecker)
            {
        ...
        public void SearchResultsPaginationViewModelTest(string searchTerm, JobProfileSearchBoxController.PageMode mode, int resultsCount, int page, int pageSize)
        {
            ...
            else
            {
                ...
                var dummyIndex = new JobProfileIndex
                {
                    ...
                    Overview = "overview",
                    UrlName = "dummy-url",
                    JobProfileCategoriesWithUrl = new string[] { "CatOneURL|Cat One", "CatTwoURL|Cat Two" }
                };
