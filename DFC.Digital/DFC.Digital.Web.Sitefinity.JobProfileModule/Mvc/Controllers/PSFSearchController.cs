...
namespace DFC.Digital.Web.Sitefinity.JobProfileModule.Mvc.Controllers
{
    ...
    public class PsfSearchController : BaseDfcController
    {
        ...
        public MvcHtmlString CaveatTagMarkup { get; set; } = new MvcHtmlString(@"<strong class=""govuk-tag govuk-tag--grey"">COVID Impacted</strong>");

        [DisplayName("Caveat disclaimer")]
        public MvcHtmlString CaveatMarkup { get; set; } = new MvcHtmlString(@"<p class=""govuk-inset-text"">This may be impacted in the short term due to current Coronavirus pandemic</p>");
